    ...
    try {
      await interaction.guild.channels.create({
        ...
        const membed = new EmbedBuilder()
          ...
          .setDescription('Start by joining a voice channel and type any `song/link` here!\n╰ Visit: [Waifu Website](https://waifu-music.is-a.fun/) | [Invite WaifuMusic](https://discord.com/api/oauth2/authorize?client_id=1090120136167538748&permissions=8&scope=bot%20applications.commands) | [Support server!](https://discord.gg/WFfjrQxnfH)')
