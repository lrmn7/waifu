...
module.exports = {
  ...
  description: 'Support L RMN on Ko-fi!', // description of the command
      ...
      await interaction.reply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription('**[Support L RMN on Ko-fi! ❤️. ko-fi.com/L RMN](https://ko-fi.com/lrmn7)**\n\nSupport L RMN On Ko-fi. Ko-fi lets you support the people and causes you love with small donations')
            .setImage(hachiki)
        ]
      })
    } catch (e) {
